...
/* DISCLAIMER:
 * THIS CODE REVISION SHOULD BE TREATED AS PROOF-OF-CONCEPT THING.
 * IT IS WRITTEN IN TERRIBLY BAD MANNER AND IT WILL BE CORRECTED LATER.
 * KEEP THAT IN MIND (nobody cares about that but whatever) */
